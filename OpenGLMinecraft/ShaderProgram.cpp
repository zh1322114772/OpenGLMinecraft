...
namespace wrapperGL
{
	...
	ShaderProgram::ShaderProgram(std::string& vertexProgram, std::string& fragmentProgram) 
	{
		const char* vertexCode = vertexProgram.c_str();
		const char* fragmentCode = fragmentProgram.c_str();
